...
<body>
        ...
        <form id="WebToLeadForm" action="https://hook.us1.make.com/2mk3ouv2dc515gqufsd4hlmnf2atnnfg" method="POST" name="WebToLeadForm">
            <div class="float-panel" id="flt-lic-panel">
                ...
                <div class="float-body" id="flt-lic-form-wrap">
                    ...
                    <input type="hidden" name="utm_url" id="utm_url" value="">
        ...
        <div class="wrap">
            <div class="prog-head">
                ...
                <div class="info-box">
                    ...
                    <div class="info-row"><span class="lbl">Directora</span><span class="val">Mtra. Alejandra López Valenzuela</span></div>
                </div>
            </div>
        ...
        <div class="wrap">
            ...
            <div class="faculty-grid">
                <div class="fc" itemscope itemtype="https://schema.org/Person">
                    <div class="fc-name" itemprop="name">Mtra. Alejandra López Valenzuela</div>
                    <div class="fc-degree">Directora · Licenciatura en Psicología</div>
                    <p class="fc-spec" itemprop="knowsAbout">Evaluación e intervención psicoeducativa. Coordinadora clínica del Centro ASI — 5 años de trabajo especializado con personas con condición autista y +19 años de docencia. Coautora de <em>Autismo, subjetividad e intervención psicoanalítica</em>.</p>
                </div>
                <div class="fc" itemscope itemtype="https://schema.org/Person">
    ...
    <script>
        ...
        const floatMap = {}; // sectionId -> floatId
        ...
        const floatObserver = new IntersectionObserver(entries => {
            entries.forEach(e => {
                ...
                if (e.isIntersecting) {
                    ...
                    // slight delay before slide in
                    setTimeout(() => floatEl.classList.add('is-visible'), 60);
                    document.querySelector('.grecaptcha-badge').classList.add('is-visible');
                    currentFloat = floatId;
                } else {
                    // only hide if it was this section's float
                    if (currentFloat === floatId) {
                        // ─── CERRAR el panel antes de ocultar ───
        ...
        document.querySelectorAll('details').forEach(d => {
            d.addEventListener('toggle', () => {
                if (!d.open) return;
                const parent = d.closest('.faq-wrap') || document;
        ...
        /* ─── SCROLL REVEAL ─── */
        const revealEls = document.querySelectorAll('.pcard, .content-box, .fc, .stat');
        ...
        links.forEach(link => {
            link.addEventListener('click', e => {
                ...
                if (PROGRAM_IDS.includes(targetId)) {
                    ...
                    // Regresar scroll a la sección de programas
    ...
    <script>
        grecaptcha.ready(function() {
            grecaptcha.execute('6LekquUoAAAAAGMnfbnWFjD7VfrLHLjvNOfIP-Ae', {
                ...
                .then(function(token) {
                    // Aplica el token a TODOS los formularios de la página
